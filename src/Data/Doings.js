...
import it from 'assets/it-icon.png';
import cyber from 'assets/cyber-icon.png';
import strategy from 'assets/strategy-icon.png';
import custom from 'assets/custom-icon.png';
import arrow from 'assets/web-arrow.png';
